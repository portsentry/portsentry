# fuzz-string-utils Specification

## Purpose

Provide continuous fuzz-testing coverage of PortSentry's string-utility helpers so that adversarial inputs cannot cause buffer overflows or other memory-safety errors.
