# fuzz-ignore-file Specification

## Purpose

Provide continuous fuzz-testing coverage of PortSentry's ignore-file line parsing so that malformed ignore entries cannot cause memory-safety errors.
